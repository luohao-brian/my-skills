...
export interface NetworkJournalLike {
  start(): Promise<void>;
  stop(): void;
  ...
  ensureBody(entry: NetworkEntry): Promise<string | undefined>;
  getJsonBody(entry: NetworkEntry): Promise<unknown | null>;
  toJSON(options?: { includeBodies?: boolean }): Promise<NetworkEntry[]>;
}
...
export class NetworkJournal implements NetworkJournalLike {

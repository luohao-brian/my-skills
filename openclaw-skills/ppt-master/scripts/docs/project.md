...
```bash
python3 {baseDir}/scripts/project_manager.py init my_presentation --format ppt169
...
```bash
python3 {baseDir}/scripts/batch_validate.py <external-project-root>
python3 {baseDir}/scripts/batch_validate.py <project-a> <project-b> --export
```

Use this for checking one or more project directories outside the skill source.

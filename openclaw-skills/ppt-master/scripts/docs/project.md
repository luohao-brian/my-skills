...
```bash
python3 scripts/project_manager.py init my_presentation --dir <absolute-projects-root>
...
python3 scripts/project_manager.py init my_widescreen --format ppt169 --dir <absolute-projects-root>

...
```bash
python3 {baseDir}/scripts/rotate_images.py sheet <images_directory>
```
...
```bash
python3 {baseDir}/scripts/rotate_images.py fix /tmp/orientation_fixes.json
python3 {baseDir}/scripts/analyze_images.py <images_directory>
```

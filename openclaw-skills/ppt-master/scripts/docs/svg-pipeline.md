...
- Recorded narration is opt-in:
  ...
  - Voice choices can be listed with `python3 {baseDir}/scripts/notes_to_audio.py --list-common-voices`, `python3 {baseDir}/scripts/notes_to_audio.py --list-voices --locale zh-CN`, or provider-specific `--provider <name> --list-voices`

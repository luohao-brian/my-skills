...
python3 scripts/project_manager.py init <project_name> --dir <absolute-projects-root>
...
| Animation resources | `sound_sync.py` | [sound vocabulary and sync](../templates/sounds/_index.md); [docs/pptx-animations.md](./docs/pptx-animations.md) |
...
```bash
python3 scripts/project_manager.py init <project_name> [--format <registered_format>] --dir <absolute-projects-root>
python3 scripts/project_manager.py import-sources <project_path> <source_files_or_dirs...>

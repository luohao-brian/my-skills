...
```bash
python3 {baseDir}/scripts/project_manager.py init <project_name> [--format <format>]                 # Default --dir <absolute-projects-root>
python3 {baseDir}/scripts/project_manager.py init <project_name> [--format <format>] --quick-generate # Quick — run exactly one init --dir <absolute-projects-root>
python3 {baseDir}/scripts/project_manager.py import-sources <project_path> <source.pptx>
```
...
python3 {baseDir}/scripts/extract_svg_assets.py <project_path>/analysis/source_svg_import/svg-flat --icons-dir <project_path>/analysis/source_svg_import/icons --icon-namespace imported --inplace --id-prefix source_flat --min-decoration-bytes 3000 --clean-stale
```
...
```bash
python3 {baseDir}/scripts/beautify_inventory.py <project_path>/analysis/<stem>.slide_library.json --images <project_path>/images/image_manifest.json -o <project_path>/analysis/beautify_inventory.json
```

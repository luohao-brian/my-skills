...
```bash
python3 {baseDir}/scripts/pptx_to_svg.py "<source.pptx>" -o "projects/<slug>_<YYYYMMDD>" --inheritance-mode both --roundtrip
```
...
```bash
python3 {baseDir}/scripts/svg_authoring_view.py "projects/<slug>_<YYYYMMDD>/authoring-svg-flat" --adopt-object slide_05.svg:<element-id> --into chapter_market.svg
```
...
```bash
python3 {baseDir}/scripts/svg_authoring_view.py "projects/<slug>_<YYYYMMDD>/authoring-svg-flat" --refresh-summary
python3 {baseDir}/scripts/svg_quality_checker.py "projects/<slug>_<YYYYMMDD>" --roundtrip --json
```
...
```bash
python3 {baseDir}/scripts/svg_to_pptx.py "projects/<slug>_<YYYYMMDD>" --roundtrip
```

...
```bash
python3 {baseDir}/scripts/native_enhance_pptx.py plan "<project>"
```
...
```bash
python3 {baseDir}/scripts/native_enhance_pptx.py validate "<project>" --materials notes
```
...
```bash
python3 {baseDir}/scripts/native_enhance_pptx.py apply "<project>"
```
...
```bash
python3 {baseDir}/scripts/source_to_md/ppt_to_md.py \

...
| `style` | [`templates/styles/_index.md`](../../templates/styles/_index.md) | Direction/method: reusable communication method, visual language, composition, and information-expression defaults |
...
```bash
python3 {baseDir}/scripts/svg_quality_checker.py "<workspace_root>/templates" --template-mode
```

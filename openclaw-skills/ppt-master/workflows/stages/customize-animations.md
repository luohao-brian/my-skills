...
```bash
python3 {baseDir}/scripts/animation_config.py validate <project_path>
```
...
```bash
python3 {baseDir}/scripts/animation_config.py list-groups <project_path>
```
...
```bash
python3 {baseDir}/scripts/animation_config.py scaffold <project_path>
```
...
Run
`python3 {baseDir}/scripts/pptx_animations.py --describe-transition <effect>`
...
`python3 {baseDir}/scripts/pptx_animations.py --list` for the exact
...
`python3 {baseDir}/scripts/pptx_animations.py --describe
...
```bash
python3 {baseDir}/scripts/video_motion_plan.py \

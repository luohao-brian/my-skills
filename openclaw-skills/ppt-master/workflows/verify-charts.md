...
5. Run the matching calculator command:
   ...
   python3 {baseDir}/scripts/svg_position_calculator.py calc bar \
   ...
   python3 {baseDir}/scripts/svg_position_calculator.py calc line \
   ...
   python3 {baseDir}/scripts/svg_position_calculator.py calc pie \
   ...
   python3 {baseDir}/scripts/svg_position_calculator.py calc radar \

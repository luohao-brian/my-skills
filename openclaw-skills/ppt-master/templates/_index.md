...
- **Directory overview**: [charts/_index.md](./charts/_index.md)
...
- **Usage & style rules**: [icons/_index.md](./icons/_index.md)
- **Search icons**: `rg --files {baseDir}/templates/icons/<library>/ | rg <keyword>`

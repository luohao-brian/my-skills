...
```bash
python3 {baseDir}/scripts/icon_sync.py <project_path> tabler-outline/home tabler-outline/bulb simple-icons/github
```
...
```bash
rg --files "{baseDir}/templates/icons/tabler-outline" -g '*chart*.svg'
rg --files "{baseDir}/templates/icons/simple-icons" -g '*github*.svg'
```

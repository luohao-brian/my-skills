...
kind and workspace model lives in the parent [`_index.md`](../_index.md).
...
```
Read {baseDir}/workflows/create-template.md, which dispatches `kind: brand` to {baseDir}/workflows/create-template/create-brand.md
```

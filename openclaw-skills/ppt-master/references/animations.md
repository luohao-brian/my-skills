...
python3 {baseDir}/scripts/animation_config.py scaffold <project>

# Validate references before export
python3 {baseDir}/scripts/animation_config.py validate <project>
...
python3 {baseDir}/scripts/svg_to_pptx.py <project> --auto-advance 5
...
python3 {baseDir}/scripts/svg_to_pptx.py <project> -a auto

# Enable with a single effect (cascades via the after-previous trigger)
python3 {baseDir}/scripts/svg_to_pptx.py <project> --animation fade

# Enable and switch to on-click for live presentations (presenter controls pacing)
python3 {baseDir}/scripts/svg_to_pptx.py <project> -a auto --animation-trigger on-click

# Custom pacing
python3 {baseDir}/scripts/svg_to_pptx.py <project> --animation mixed \
        --animation-stagger 0.7 --animation-duration 0.5

# All groups animate in unison on slide entry
python3 {baseDir}/scripts/svg_to_pptx.py <project> -a auto --animation-trigger with-previous
```
...
Executors should wrap logical sections in `<g id>` regardless of whether you plan to animate. The Executor reference (`{baseDir}/references/shared-standards.md`) requires it.

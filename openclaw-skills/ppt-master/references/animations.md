...
python3 {baseDir}/scripts/animation_config.py list-groups <project>
...
- Run `python3 {baseDir}/scripts/pptx_animations.py --describe
...
```bash
python3 {baseDir}/scripts/pptx_animations.py --list
```

...
Everything here is a plan-only or Reference decision under [`ownership.md`](https://github.com/hugohe3/ppt-master/blob/v6.6.0/docs/rules/ownership.md): content, relationships, roster, rhythm, identity anchors, and resources bind; macro composition, motif, and pattern suggestions are References the Executor adjusts freely.

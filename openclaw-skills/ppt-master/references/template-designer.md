...
- **Workspace root**: `library` (default) → `{baseDir}/templates/<kind_dir>/<template_name>/`; `project` → the confirmed `<target_project>/`
...
|---|---|
| `library` | `{baseDir}/templates/<kind_dir>/<template_name>/` |

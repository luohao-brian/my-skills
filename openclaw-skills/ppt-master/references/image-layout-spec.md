...
```bash
python3 {baseDir}/scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
python3 {baseDir}/scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
python3 {baseDir}/scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```

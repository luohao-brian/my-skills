...
|---|---|---|
| `analysis/image_analysis.csv` | Current `images/` | `python3 {baseDir}/scripts/analyze_images.py <project_path>/images` |
| `notes/slide_*.md` | `notes/total.md` | `python3 {baseDir}/scripts/total_md_split.py <project_path>` |
| `svg_final/` | `svg_output/` plus project assets | `python3 {baseDir}/scripts/finalize_svg.py <project_path>` |
| Native PPTX | `svg_output/` plus notes/assets | `python3 {baseDir}/scripts/svg_to_pptx.py <project_path>` |

...
def main() -> int:
    ...
    parser.add_argument("--audio", dest="audio", action="store_true", default=True, help="Request generated audio when the model supports it")
    parser.add_argument("--no-audio", dest="audio", action="store_false", help="Disable generated audio")

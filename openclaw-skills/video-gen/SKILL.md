...
metadata: {"openclaw":{"skillKey":"video-gen","emoji":"🎬","homepage":"https://github.com/luohao-brian/my-skills/tree/main/openclaw-skills/video-gen","requires":{"anyBins":["python3","python"],"env":["VOLC_AGENT_PLAN_API_KEY"]},"primaryEnv":"VOLC_AGENT_PLAN_API_KEY","install":[{"id":"python-deps","kind":"uv","package":"volcengine-python-sdk[ark]>=5.0.5,<6"}]}}
---

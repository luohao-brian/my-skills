...
- `https://hex2077.dev/docs/`
  - 取数：解析目标日期页 HTML 索引 `https://hex2077.dev/docs/YYYY-MM/YYYY-MM-DD/`；目标日期页不存在时，解析目标日期前后 `72` 小时内最近的已发布日期页

...
assert_contains "$AI_NEWS_DIR/SKILL.md" "## 输出要求" "SKILL.md documents output requirements"
...
assert_contains "$AI_NEWS_DIR/sources.md" "### Google AI / Google DeepMind" "sources include Google official priority"

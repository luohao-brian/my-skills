...
assert_contains "$AI_NEWS_DIR/format.md" "## Agent" "format defines Agent category"
assert_contains "$AI_NEWS_DIR/format.md" "## 技术博客" "format defines technical blog category"
